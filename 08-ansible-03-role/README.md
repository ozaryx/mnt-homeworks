...
```shell
macbook0P0LYWK:08-ansible-03-role kmankov$ cd playbook/
macbook0P0LYWK:playbook kmankov$ ansible-galaxy install -r requirements.yml --roles-path ./
Starting galaxy role install process
- extracting java to /Users/kmankov/PycharmProjects/mnt-homeworks/08-ansible-03-role/playbook/java
